...
CREATE TABLE public.agent_sessions (
    ...
    CONSTRAINT check_positive_execution_time CHECK ((execution_time_seconds >= (0)::numeric))
);
...
CREATE TABLE public.recommendations (
    ...
    CONSTRAINT check_composite_score_range CHECK (((composite_score >= (0)::numeric) AND (composite_score <= (100)::numeric))),
...
CREATE TABLE public.stocks (
    ...
    tipo_acao character varying(10),
...
COPY public.stocks (id, codigo, nome, nome_completo, setor, subsetor, segmento, industria, cnpj, website, descricao, ceo, funcionarios, ano_fundacao, sede_cidade, sede_estado, status, listagem_b3, tipo_acao, current_price, previous_close, day_high, day_low, week_52_high, week_52_low, volume_medio_30d, volume_atual, market_cap, enterprise_value, shares_outstanding, free_float_percent, pe_ratio, pb_ratio, ps_ratio, ev_ebitda, ev_revenue, peg_ratio, roe, roa, roic, gross_margin, operating_margin, net_margin, ebitda_margin, debt_to_equity, debt_to_ebitda, current_ratio, quick_ratio, interest_coverage, asset_turnover, inventory_turnover, receivables_turnover, revenue_ttm, revenue_annual, gross_profit_ttm, operating_income_ttm, net_income_ttm, ebitda_ttm, total_assets, total_equity, total_debt, net_debt, cash_and_equivalents, working_capital, revenue_growth_yoy, revenue_growth_3y, earnings_growth_yoy, earnings_growth_3y, book_value_growth_3y, fundamental_score, valuation_score, profitability_score, growth_score, financial_health_score, overall_rank, sector_rank, market_cap_rank, data_quality, data_completeness, confidence_level, last_analysis_date, created_at, updated_at, last_price_update, last_fundamentals_update, yfinance_data, additional_metrics, analyst_estimates, esg_scores) FROM stdin;
\.
...
--
-- Name: idx_agent_session_name_status; Type: INDEX; Schema: public; Owner: investment_user
--

CREATE INDEX idx_agent_session_name_status ON public.agent_sessions USING btree (agent_name, status);


--
-- Name: idx_agent_session_started; Type: INDEX; Schema: public; Owner: investment_user
--

CREATE INDEX idx_agent_session_started ON public.agent_sessions USING btree (started_at);
...
--
-- Name: idx_fundamental_sector_rank; Type: INDEX; Schema: public; Owner: investment_user
--

CREATE INDEX idx_fundamental_sector_rank ON public.fundamental_analyses USING btree (sector_rank);
...
--
-- Name: idx_market_data_date; Type: INDEX; Schema: public; Owner: investment_user
--

CREATE INDEX idx_market_data_date ON public.market_data USING btree (date);
...
--
-- Name: idx_stock_nome_gin; Type: INDEX; Schema: public; Owner: investment_user
--

CREATE INDEX idx_stock_nome_gin ON public.stocks USING gin (nome public.gin_trgm_ops);
...
CREATE INDEX idx_stock_sector_rank ON public.stocks USING btree (setor, sector_rank);


--
-- Name: idx_stock_setor_status; Type: INDEX; Schema: public; Owner: investment_user
--

CREATE INDEX idx_stock_setor_status ON public.stocks USING btree (setor, status);
